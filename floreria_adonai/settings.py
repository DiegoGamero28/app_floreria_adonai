"""
Django settings for floreria_adonai project.
...
SECRET_KEY = 'django-insecure-lth4h+rmb$e)5e4djf)(pm@^6k=sii*06uay=^b@$)om1)@de$'
...
ROOT_URLCONF = 'floreria_adonai.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'gestion.context_processors.floreria_config',
            ],
        },
    },
]

WSGI_APPLICATION = 'floreria_adonai.wsgi.application'
